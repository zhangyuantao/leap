module planetJump {
	export class ItemDefine {		
		...
		public static ScoreBall_new:string = "ScoreBall_new";
		public static Explode:string = "Explode";
		public static ExplodeSpike:string = "ExplodeSpike";
		public static MegaJump:string = "MegaJump";
		...
		public static ObSquare_new:string = "ObSquare_new";
		public static ObTube:string = "ObTube";
	}
}
